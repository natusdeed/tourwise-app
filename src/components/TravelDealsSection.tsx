...
const deals: TravelDealCard[] = [
  {
    ...
    icon: Plane,
    cta: AFFILIATE_LINKS.flights.aviasales.label,
  ...
  },
  {
    ...
    icon: Compass,
    cta: AFFILIATE_LINKS.tours.klook.label,
  ...
  },
  {
    ...
    icon: Bus,
    cta: AFFILIATE_LINKS.transfers.kiwitaxi.label,
  ...
  },
  {
    ...
    icon: Smartphone,
    cta: AFFILIATE_LINKS.esim.airalo.label,
  ...
  },
  {
    ...
    icon: Car,
    cta: AFFILIATE_LINKS.carRentals.localrent.label,
  ...
  },
  {
    ...
    icon: ShieldAlert,
    cta: AFFILIATE_LINKS.insurance.ekta.label,
  ...
  },
  {
    ...
    icon: Scale,
    cta: AFFILIATE_LINKS.compensation.airhelp.label,
